...
class CustomLib:
    ...
    *Example:*
    ...
    def is_element_present_SAP(self, element_id):
        try:
    ...
    def expand_node(self):
        ...
        session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").topNode = "N1"
        session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").selectItem("N11", "Column1")
        session.findById("wnd[0]/usr/cntlTREE_CONTAINER/shellcont/shell").ensureVisibleHorizontalItem("N11","Column1")
        session.findById("wnd[0]/tbar[1]/btn[8]").press()
